...
I'm also spending much of my time learning about and exploring AI—building new tools, training and finetuning [models](https://www.huggingface.co), and augmenting myself as much as possible. Subscribe to my newsletted called [Daily Build](https://dailybuild.co) where I build new things daily using the latest AI tools. 
